...
import com.restfulbooker.BookingDates;
import com.restfulbooker.BookingDetails;
...
public class CreateBooking extends BaseTest {
	...
	public void createNewBooking(String firstname, 
		...
		//Sending the POST request for a specific booking id and receiving the response
